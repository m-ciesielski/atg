...
class Tree(Graph):
    ...
    def find_center(self) -> set:
        ...
        leaf_stack = deque(temp_tree.get_leaf_vertices())
        while len(temp_tree.vertices) > 2 or len(leaf_stack) > 1:
            leaf = leaf_stack.popleft()
...
def test():
    test_tree = Tree({0, 1, 2, 3, 4, 5, 6}, [(0, 1), (0, 2), (1, 3), (1, 4), (2, 5), (5, 6)])
    print(test_tree.find_center())
    test_tree_2 = Tree({0, 1, 2, 3, 4, 5, 6, 7, 8}, [(0, 1), (0, 2), (1, 3), (1, 4), (4, 7), (7, 6), (7, 8), (2, 5)])
    print(test_tree_2.find_center())
    test_tree_3 = Tree({0, 1, 2, 3, 4}, [(0, 1), (0, 2), (0, 3), (0, 4)])
    print(test_tree_3.find_center())
    test_tree_4 = Tree({0, 1, 2, 3, 4, 5}, [(0, 1), (0, 2), (0, 3), (1, 4), (1, 5)])
